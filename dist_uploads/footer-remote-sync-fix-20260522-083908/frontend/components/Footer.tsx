                    ...
                    <div className="grid gap-8 md:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)_minmax(0,1fr)] text-sm">
                        <div className="space-y-4">
                            ...
                            <p className="text-slate-600 dark:text-slate-400 leading-relaxed max-w-md">
                                Simulador Web3 de mineracao digital com economia, estrategia e progressao no ecossistema Genesis.
                            </p>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex flex-col gap-2 text-slate-600 dark:text-slate-300">
                                <a href="https://instagram.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 hover:text-amber-500 transition-colors">
                                ...
                                <a href="https://youtube.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 hover:text-amber-500 transition-colors">
